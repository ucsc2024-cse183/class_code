...
class Assignment(AssignmentBase):
    ...
    def step05(self):
        ...
        for i, c in content:
            assert rows[i - 1].find_element(By.CSS_SELECTOR, 'td').text.lower() == c.lower(), f"First column header for row {i} is wrong"
    ...
    def step09(self):
        ...
        for tv in test_values:
            ...
            for (v1, v2, v3), expected in tv:
                ...
                assert safe_float(value_4) == expected, f"Row 4 computation for inputs {value_1}, {value_2}, {value_3}, returned {value_4} instead of {expected}"
    ...
    def step11(self):
        ...
        for v, expected in test_values:
            ...
            assert safe_float(value_14) == expected, f"Tax computation for input {v}, returned {value_14} instead of {expected}"
